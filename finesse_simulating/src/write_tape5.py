...
def write_tape5(pro_z, pro_p, pro_t, pro_q, h_start_temp, h_obs,
                h_start, wn_range, angle, atm, mode,
                pro_oco=None,
                pro_o3=None,
                pro_n2o=None,
                pro_co=None,
                ...
                pro_so2=None,
                pro_no2=None,
                t5='TAPE5', h2o_flag='A',o3_flag='A', yaxis_flag='P', path_length=None,
                horizontal=2, blackbody=True, od=0, res=0.01,
